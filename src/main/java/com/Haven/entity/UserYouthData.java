...
//import static com.Haven.utils.CommonUtil.toImageUri;
...
public class UserYouthData implements Serializable {
    ...
    public UserYouthData settingUserid(String userid) {
        if (Objects.nonNull(userid)) this.userid = userid;
        return this;
    }
    ...
    public UserYouthData settingId(String nid, String userid) {
        if (Objects.nonNull(nid)) this.nid = nid;
        if (Objects.nonNull(userid)) this.userid = userid;

        this.jobName = "j-" + this.userid;
        this.jobGroup = "jg-YouthLearn-jx-" + this.nid;
        this.triggerName = "t-" + this.userid;
        this.triggerGroup = "tg-YouthLearn-jx-" + this.nid;
        return this;
    }
    ...
    public UserYouthData settingRealName(String realName) {
        if (Objects.nonNull(realName)) this.watermarkText = realName;
        return this;
    }
    ...
    public UserYouthDataDTO toUserYouthDataDTO() {
        ...
        userYouthDataDTO.setCurrentImagePath(getImageUriById(imageId));
        userYouthDataDTO.setHistoryImagePath(getImageUriListById(imageId));
        userYouthDataDTO.setEmail(getEmailById(emailId));
        userYouthDataDTO.setUuid(uuid);
        userYouthDataDTO.setCron(Objects.isNull(getCronExpression(this)) ? cron : getCronExpression(this));
    ...
    public static class UserYouthDataBuilder {
        ...
        public UserYouthDataBuilder watermarkText(String watermarkText) {
            if (Objects.nonNull(watermarkText)) this.watermarkText = watermarkText;
            return this;
        }

        public UserYouthDataBuilder id(String userid, String nid) {
            this.userid = userid;
            this.nid = nid;
            this.jobName = "j-" + userid;
            this.jobGroup = "jg-YouthLearn-jx-" + nid;
            this.triggerName = "t-" + userid;
            this.triggerGroup = "tg-YouthLearn-jx-" + nid;
            return this;
        }
    }
